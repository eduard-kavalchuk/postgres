# Generated by Django 2.2.16 on 2022-06-12 18:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, django.contrib.gis.db.models.fields.PointField),
        ),
        migrations.CreateModel(
            name='Bookings',
            fields=[
        ...
        migrations.CreateModel(
            name='Seats',
            fields=[
                ('aircraft_code', models.ForeignKey(db_column='aircraft_code', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='demo.AircraftsData')),
        ...
        migrations.CreateModel(
            name='TicketFlights',
            fields=[
                ('ticket_no', models.ForeignKey(db_column='ticket_no', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='demo.Tickets')),
                ('fare_conditions', models.CharField(max_length=10)),
        ...
        migrations.CreateModel(
            name='BoardingPasses',
            fields=[
                ('ticket_no', models.ForeignKey(db_column='ticket_no', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='demo.TicketFlights')),
